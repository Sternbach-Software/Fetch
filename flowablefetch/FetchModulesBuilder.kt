...
object FetchModulesBuilder {
    ...
    fun buildModulesFromPrefs(fetchConfiguration: FlowableFetchConfiguration): Modules {
        return synchronized(lock) {
            ...
            val modules = if (holder != null) {
                ...
                val newDatabaseManager = fetchConfiguration.fetchDatabaseManager
                    ?: FlowableFetchDatabaseManagerImpl(
                ...
                val databaseManagerWrapper = FlowableFetchDatabaseManagerWrapper(newDatabaseManager)
    ...
    data class Holder(
        ...
        val fetchDatabaseManagerWrapper: FlowableFetchDatabaseManagerWrapper,
        val downloadProvider: DownloadProvider,
        val groupInfoProvider: flowablefetch.GroupInfoProvider,
    ...
    class Modules(
        val fetchConfiguration: FlowableFetchConfiguration,
        val handlerWrapper: HandlerWrapper,
        val fetchDatabaseManagerWrapper: FlowableFetchDatabaseManagerWrapper,
        val downloadProvider: flowablefetch.DownloadProvider,
        val groupInfoProvider: flowablefetch.GroupInfoProvider,
        val uiHandler: Handler,
        downloadManagerCoordinator: DownloadManagerCoordinator,
        val listenerCoordinator: flowablefetch.ListenerCoordinator
    ) {
        ...
        init {
            ...
            fetchHandler = fetchConfiguration.fetchHandler ?: FlowableFetchHandlerImpl(
                namespace = fetchConfiguration.namespace,
