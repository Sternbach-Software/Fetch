 ...
 * @see Builder
 * */
class FlowableFetchConfiguration constructor(val appContext: Context,
                                             ...
                                             val fetchDatabaseManager: FlowableFetchDatabaseManager<DownloadInfo>?,
                                             ...
                                             val fetchHandler: FlowableFetchHandler?) {
    ...
    * */
    /*fun getNewFetchInstanceFromConfiguration(): FlowableFetch {
        return FlowableFetch.getInstance(this)
    }*/
    ...
    class Builder(context: Context) {
        ...
        private var fetchDatabaseManager: FlowableFetchDatabaseManager<DownloadInfo>? = null
        ...
        private var fetchHandler: FlowableFetchHandler? = null
         ...
         * @return Builder
         * */
        fun setDatabaseManager(fetchDatabaseManager: FlowableFetchDatabaseManager<DownloadInfo>?): Builder {
         ...
         * */
        fun setFetchHandler(fetchHandler: FlowableFetchHandler): Builder {
         ...
         * */
        fun build(): FlowableFetchConfiguration {
            ...
            return FlowableFetchConfiguration(
