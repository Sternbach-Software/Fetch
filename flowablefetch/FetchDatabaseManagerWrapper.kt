...
class FlowableFetchDatabaseManagerWrapper(private val fetchDatabaseManager: FlowableFetchDatabaseManager<DownloadInfo>): FetchDatabaseManager<DownloadInfo> {
    ...
    fun getFlow(): Flow<List<DownloadInfo>> {
        return fetchDatabaseManager.getFlow()
    }
