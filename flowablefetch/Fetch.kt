...
/*
        ...
        *//**
         ...
         * */
        fun getInstance(fetchConfiguration: FlowableFetchConfiguration): FlowableFetch {
            return FlowableFetchImpl.newInstance(flowablefetch.FetchModulesBuilder.buildModulesFromPrefs(fetchConfiguration))
        }
