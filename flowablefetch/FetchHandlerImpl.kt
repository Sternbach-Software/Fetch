 ...
 * */
class FlowableFetchHandlerImpl(private val namespace: String,
                               ...
                               private val listenerCoordinator: flowablefetch.ListenerCoordinator,
                               private val uiHandler: Handler,
                               private val storageResolver: StorageResolver,
                               private val fetchNotificationManager: FetchNotificationManager?,
                               private val groupInfoProvider: flowablefetch.GroupInfoProvider,
                               private val prioritySort: PrioritySort,
                               private val createFileOnEnqueue: Boolean) : FlowableFetchHandler {
    ...
    override fun getDownloadsFlow(): Flow<List<Download>> {
        return fetchDatabaseManagerWrapper.getFlow()
    }
