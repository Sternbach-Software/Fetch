...
open class FlowableFetchImpl(
    ...
    override val fetchConfiguration: FetchConfiguration = createFetchConfiguration()
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(modules: FetchModulesBuilder.Modules, createFetchConfiguration: () -> FetchConfiguration): FlowableFetchImpl {
